A Rust-based program designed to simulate the behavior of Multi-Level cache memory. The simulator models fundamental cache operations: hits, misses, and evictions.
